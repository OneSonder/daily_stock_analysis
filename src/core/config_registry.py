...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "REPORT_QUALIFIED_SCAN_ENABLED": {
        "title": "Qualified Scan Enabled",
        "description": "Embed S1/S2 qualified-stock scan section in daily aggregate reports.",
        "category": "notification",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 61,
        "help_key": "settings.report.REPORT_QUALIFIED_SCAN_ENABLED",
        "examples": [
    ...
    "REPORT_QUALIFIED_SCAN_STOCK_LIST": {
        ...
        "description": "Universe for qualified scan: HSI token, comma-separated codes, or JSON path.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "examples": [
            "REPORT_QUALIFIED_SCAN_STOCK_LIST=HSI",
            "REPORT_QUALIFIED_SCAN_STOCK_LIST=0700.HK,9988.HK",
        ],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
    ...
    "REPORT_QUALIFIED_SCAN_CONDITIONS": {
        "title": "Qualified Scan Conditions",
        "description": "Comma-separated S1/S2 conditions used to qualify stocks.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "REPORT_QUALIFIED_SCAN_RULE_JSON": {
        "title": "Qualified Scan Rule JSON",
        "description": "Optional JSON rules applied after built-in conditions.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "textarea",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 64,
        "help_key": "settings.report.REPORT_QUALIFIED_SCAN_RULE_JSON",
        "examples": [
            'REPORT_QUALIFIED_SCAN_RULE_JSON={"match":"all","rules":[{"field":"close","op":"gte","value":50}]}',
        ],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
    ...
    "REPORT_QUALIFIED_SCAN_PLUGIN": {
        "title": "Qualified Scan Plugin",
        "description": "Optional trusted local Python plugin path for custom match filtering.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 65,
        "help_key": "settings.report.REPORT_QUALIFIED_SCAN_PLUGIN",
        "examples": [
            "REPORT_QUALIFIED_SCAN_PLUGIN=scripts/my_qualified_scan_plugin.py",
        ],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
