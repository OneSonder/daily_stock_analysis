...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "qualified_scan_heading": "技术筛选合格股",
        "qualified_scan_none": "无股票满足筛选条件。",
        "qualified_scan_error": "技术筛选暂不可用。",
        "qualified_scan_skipped": "技术筛选已跳过。",
        "qualified_scan_code": "代码",
        "qualified_scan_name": "名称",
        "qualified_scan_close": "收盘",
        "qualified_scan_entry20": "20日高点",
        "qualified_scan_entry55": "55日高点",
        "qualified_scan_kline_score": "K线分数",
        "qualified_scan_kline_patterns": "K线形态",
    ...
    "en": {
        ...
        "qualified_scan_heading": "Qualified Stocks",
        "qualified_scan_none": "No stocks matched the filter.",
        "qualified_scan_error": "Qualified scan is unavailable.",
        "qualified_scan_skipped": "Qualified scan was skipped.",
        "qualified_scan_code": "Code",
        "qualified_scan_name": "Name",
        "qualified_scan_close": "Close",
        "qualified_scan_entry20": "20D High",
        "qualified_scan_entry55": "55D High",
        "qualified_scan_kline_score": "K-Line Score",
        "qualified_scan_kline_patterns": "K-Line Patterns",
