...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "details_report_filename_hint": "reports/ 目录，文件名含生成时间与标的数量（如 report_20260516_013537_stocks3.md）",
    },
    "en": {
        ...
        "details_report_filename_hint": "under reports/ (timestamp + stock count, e.g. report_20260516_013537_stocks3.md)",
    },
}
